...
USE [Electro]
GO
/****** Object:  Table [dbo].[Admin]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[BinhLuan]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietDonDatHang]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietKhuyenMai]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietPhieuNhap]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DonDatHang]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EmailKhuyenMai]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GioHang]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KhachHang]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KhuyenMai]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhaCungCap]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhaSanXuat]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PhieuNhap]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SanPham]    Script Date: 11/16/2021 3:04:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[ChiTietDonDatHang] ([MaDDH], [MaSP], [TenSP], [SoLuong], [DonGiaBan], [DaXoa]) VALUES (7, 41, N'Laptop LG', 1, 12000000.0000, NULL)
GO
...
GO
INSERT [dbo].[DonDatHang] ([MaDDH], [NgayLap], [MaKH], [Hoten], [DiaChiGiaoHang], [DienThoai], [Email], [PhuongThucThanhToan], [TongTien], [TinhTrang]) VALUES (7, CAST(N'2021-08-01' AS Date), 1, N'Hoàng Quang Thái', N'12 Lê Hồng Phong', N'0967823093', N'hqthai@gmail.com', N'Chuyển khoản', 12000000.0000, N'Đang cho xử lý')
GO
